                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="bg-[#0A3D62] rounded p-4 border border-[#006D77] shadow-sm">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                                    <div>
                                        <div className="text-2xl font-bold text-[#00A8B5]">{progressSummary.completedQuests}</div>
                                        <div className="text-xs text-gray-400 uppercase mt-1">Nhiệm vụ đã học</div>
                                    </div>
                                    <div>
                                        <div className="text-2xl font-bold text-[#00A8B5]">{progressSummary.completedChallenges}</div>
                            ...
                            <div className="bg-[#0A3D62] rounded p-4 border border-[#006D77] shadow-sm">
                                <div className="flex space-x-1 mb-4 border-b border-[#006D77]">
                                    {["Bài đăng", "Dự án", "Chứng chỉ"].map((tab) => (
                                        <button
                                            key={tab}
                                            onClick={() => setActiveTab(tab)}
                                            className={`px-4 py-2 text-sm border-b-2 transition-colors duration-150 ${activeTab === tab
                                                ? "border-[#00A8B5] text-white"
                                ...
                                <div className="text-center text-sm text-gray-400 py-4 min-h-[50px]">
                                    {activeTab === "Bài đăng" && (
                                        <>
                                            ...
                                            <a href="#" className="text-[#00A8B5] hover:underline">
