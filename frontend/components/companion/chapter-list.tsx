            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {chapters.map((chapter) => (
                    <div
                        ...
                        className={`w-full h-40 rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_#000000] relative flex flex-col items-center justify-center p-4 cursor-pointer transition-colors duration-200 hover:bg-opacity-80 ${chapter.isSpecial
                    ...
                    >
                        ...
                        {/* Nội dung */}
                        <h3 className="text-xl font-bold text-[#104A7A] text-center">{chapter.name}</h3>
